...
const ALT_MAP = {
  ...
  'Squat à la Smith':             'Smith_Machine_Squat',
  'Fentes avant barre':                'Barbell_Lunge',
  // Bench
  'Développé haltères plat':       'Dumbbell_Bench_Press',
  ...
  // Barbell row
  'Rowing haltère un bras':       'One-Arm_Dumbbell_Row',
  ...
  'Câble incliné croisé':      'Cable_Crossover',
  ...
  'Élévations haltères':            'Side_Lateral_Raise',
  ...
  'Extension crâne EZ':           'EZ-Bar_Skullcrusher',
  'Extension crâne':              'EZ-Bar_Skullcrusher',
